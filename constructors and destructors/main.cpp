...
public:
    ...
    Animal(const string &type, const string &name, const string &sound); // parameterised constructor
...
Animal & Animal::operator=(const Animal & rhs) {  // this is operator overloading of assignment operator
    puts("copy operator");
    if(this != &rhs){
        _name = clone_prefix + rhs._name;
        _type = rhs._type;
